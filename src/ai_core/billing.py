        ...
        try:
            ...
            return {
                ...
                'usage': {
                    ...
                    'projected_monthly_tokens': round(
                        projected_monthly_tokens, 2
                    ),
                ...
                'credits_remaining': max(
                    0, monthly_credits - (total_tokens // 1000)
                ),
            }
    ...
    async def check_usage_limits(
        ...
        try:
            ...
            if feature not in ai_features:
                return (
                    False,
                    f"AI feature '{feature}' not available in your plan",
                )
            ...
            if (
                current_credits_used + estimated_credits_needed
                > monthly_credits
            ):
                return (
                    False,
                    f'Insufficient credits. Need {estimated_credits_needed}, have {monthly_credits - current_credits_used} remaining',
                )
        ...
        try:
            ...
            return {
                ...
                'current_month': {
                    ...
                    'credits_remaining': max(
                        0, monthly_credits - (current_tokens // 1000)
                    ),
                },
                'last_7_days': {
