...
class OAuthProviders:
    ...
    def get_scopes(self, provider_name: str) -> list:
    ...
    async def get_access_token(self, provider_name: str, code: str, redirect_uri: str) -> str:
    ...
    async def get_user_info(self, provider_name: str, access_token: str) -> Dict[str, Any]:
        ...
        if provider_name == 'google':
            ...
            return await self._get_apple_user_info(access_token)
        else:
    ...
    async def _get_github_user_info(self, access_token: str) -> Dict[str, Any]:
        ...
        async with httpx.AsyncClient() as client:
            ...
            primary_email = next(
                (email for email in emails_data if email.get('primary', False)),
