...
def upgrade() -> None:
    ...
    # Create email_tokens table (depends on users via email, not FK)
    op.create_table(
        'email_tokens',
    ...
    # Create subscription_plans table (no dependencies)
    op.create_table(
        'subscription_plans',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    # Create customer_subscriptions table (depends on organizations and subscription_plans)
    op.create_table(
    ...
    # Create projects table (depends on organizations)
    op.create_table(
        'projects',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('name', sa.String(length=100), nullable=False),
    ...
    # Create activity_logs table (depends on users, organizations, projects)
    op.create_table(
        'activity_logs',
        sa.Column('id', sa.Integer(), nullable=False),
    ...
    # Create email_verification_tokens table (depends on users)
    op.create_table(
    ...
    # Create team_invitations table (depends on users and organizations)
    op.create_table(
        'team_invitations',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('organization_id', sa.Integer(), nullable=False),
